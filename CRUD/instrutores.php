        ...
        <tbody>
          ...
          foreach ($instrutores as $instrutor) {
            ...
            foreach ($especializacoes as $especializacao)
              echo "<td>" . $especializacao["nomeEspecializacao"] . "</td>";
            echo "<td>" . $instrutor["celular"] . "</td>";
            if ($_SESSION["acesso"] == 1) {
              echo "<td><span>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="verify/instrutor/editar.php" method="post" class="needs-validation" novalidate>
            ...
            <div class="mb-3 mx-4">
              <span class="form-label">Especialização</span>
              <select class="form-select" name="idespecializacao" multiple aria-label="Multiple select example" required>
                <?php
