...
<div id="bdSidebar" data-bs-backdrop="static" class="h-100 d-flex flex-column bg-body shadow flex-shrink-0 p-3 text-white offcanvas offcanvas-start">
  ...
  <ul id="sidebar" class="nav nav-pills flex-column mb-auto">
    ...
    <li class="nav-item mb-2">
      <a href="instrutores.php" class="active text-decoration-none text-white rounded-1 d-block w-100">
    ...
    <li class="nav-item mb-2">
      <a href="funcionarios.php" class="active text-decoration-none text-white rounded-1 d-block w-100">
        <i class="text-center fa-solid fa-users"></i>
        Usuários
      </a>
    </li>';
